...
TURBO_FLAG(int32_t, port, 8001, "TCP Port of this server");
...
int main(int argc, char* argv[]) {
    ...
    app->add_option_function<bool>("--send_attachment", [](bool v) {
        turbo::set_flag(&FLAGS_send_attachment, v);
    }, "Carry attachment along with response");
