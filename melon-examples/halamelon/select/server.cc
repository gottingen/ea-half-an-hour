...
TURBO_FLAG(int32_t, port, 8114, "TCP Port of this server");
...
TURBO_FLAG(int32_t, server_num, 7, "Number of servers");
...
int main(int argc, char* argv[]) {
    ...
    app->add_option("-t,--spin", FLAGS_spin, "spin rather than sleep");
